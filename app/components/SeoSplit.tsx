      ...
      <div className="bg-surface border border-border rounded-2xl overflow-hidden shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 items-stretch">
          ...
          <div className="p-5 border-b md:border-b-0 md:border-r border-border">
            ...
            <div className="flex items-center gap-2 border border-border rounded-full px-3 py-2 mb-4 bg-frame min-h-[34px]">
        ...
        {/* Tagline */}
        <div className="px-6 py-4 bg-base border-t border-border text-center">
